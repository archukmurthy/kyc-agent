...
function create(){
  ...
  const providerLineage=provider?provider.configuration():{provider:"anthropic",model:process.env.EVIDENCE_A3_ANTHROPIC_MODEL||null,instructionReference:"evidence-r3-live-v1-multimodal-locators"};
