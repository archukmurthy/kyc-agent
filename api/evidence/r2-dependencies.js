...
function create(){
  ...
  const providerLineage=provider?provider.configuration():{provider:"anthropic",model:process.env.EVIDENCE_A3_ANTHROPIC_MODEL||null,instructionReference:"evidence-a3-live-v5-multi-artifact"};
