...
| Effective-interest route | File 01 §6.2; File 02 §3 | MLR 2017 Reg 5(1)(b) | None for existing arithmetic | Adopted interpretation declared | Wave 3 wrapper | Existing `ubo-percentage-lookthrough-v1`; no arithmetic change |
...
| Statutory economic threshold | File 01 §4.1; File 02 §4 | MLR 2017 Reg 5(1)(b) | A-08 production baseline | Mandatory `>25` | Wave 3 consumption | Immutable policy threshold; no tenant lowering |
| Statutory voting threshold | File 01 §4.1; File 02 §4 | MLR 2017 Reg 5(1)(b) | A-08 production baseline | Mandatory `>25` | Wave 3 consumption | Kept separate from economic threshold |
| Firm collection threshold | File 01 §§4.2–4.3; File 02 §4 | Firm-policy concept | Firm approval if enabled | Disabled | Wave 3 or later | Null threshold; cannot suppress/project statutory status |
