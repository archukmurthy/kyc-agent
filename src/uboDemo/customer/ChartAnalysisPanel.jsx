...
export default function ChartAnalysisPanel({ analysis, method, onMethodChange, legacyProjection = null, sourceProjection = null }) {
  ...
  return <section className="ubo-customer-chart-analysis" aria-label="Uploaded chart analysis">
    ...
    <p className="ubo-customer-source-map-note"><strong>Calculation scope.</strong> Effective ownership is calculated from the source-backed ownership chain as depicted in this uploaded chart. The result is provisional and does not independently verify that the chart remains current today.</p>
